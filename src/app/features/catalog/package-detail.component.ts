// src/app/features/catalog/package-detail.component.ts
...
@Component({
  ...
  imports: [CommonModule, RouterLink], // ⬅️ importante!
  template: `
...
export class PackageDetailComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // ajuste: dependendo da sua API, pode vir array; adapte se necessário
