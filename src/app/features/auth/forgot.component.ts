// src/app/features/auth/forgot.component.ts
...
export class ForgotComponent {
  ...
  sentOnce = false;
  cooldown = 0;      // segundos para novo envio
  ...
  async submit(f: NgForm) {
    ...
    try {
      const redirectTo = `${window.location.origin}/auth/reset`; // <- abre a tela de definir nova senha
      ...
      // inicia cooldown de 45s para evitar spam de envios
